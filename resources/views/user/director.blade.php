        ...
        <div class="col-4">
                <div class="dashbox">
                    <div class="card-body text-center">
                        ...
                        <img src="{{ asset('img/' . $director->photo) }}" height="326x" class="img-fluid" alt="Responsive image">
                    </div>
                </div>
            </div>
        <div class="col-8">
            <div class="dashbox">
                <div class="dashbox__title" style="color:white">
                    <h2 style="margin:0%">{{ $director->director_name }}</h2>
                </div>
                <div class="col-12">
                    <div class="dashbox__body" style="color:white">
                        <div>
                            <p style="margin: 15px"><strong>Name:</strong> {{ $director->director_name }}</p>
                            <p style="margin: 15px"><strong>Occupation:</strong> {{ $director->occupation }}</p>
                            <p style="margin: 15px"><strong>Nationality:</strong> {{ $director->Nationality  }}</p>
                            <p style="margin: 15px"><strong>Gender:</strong> {{ $director->gender }}</p>
                            <p style="margin: 15px"><strong>Date of Birth:</strong> {{ $director->Date_of_Birth }}</p>
                            <p style="margin: 15px"><strong>Age:</strong> {{ $director->age }} years old</p>
                        </div>
